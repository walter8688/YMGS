<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/BetBase.Master" AutoEventWireup="true" CodeBehind="DealReportFrm.aspx.cs" Inherits="YMGS.Manage.Web.ReportCenter.DealReportFrm" %>
...
<table class="NoBorderTable" width="100%">
    <tr>
        <td>
            <asp:GridView ID="gdvDeal" runat="server" AutoGenerateColumns="false" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BackUser" HeaderText="投注人" />
                    <asp:BoundField DataField="LayUser" HeaderText="受注人" />
                </Columns>
            </asp:GridView>
