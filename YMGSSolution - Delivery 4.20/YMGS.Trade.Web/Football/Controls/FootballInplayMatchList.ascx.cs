...
{
    public partial class FootballInplayMatchList : System.Web.UI.UserControl,IScriptControl
    {
        ...
        public int InPlayTabId { get; set; }
        public IEnumerable<MarketFlagObject> MarketFlagList { get; set; }
        public IEnumerable<string> InplayTabList { get; set; }
        public IEnumerable<FootballObject> FootballList { get; set; }

        internal const string ClientControlType = "YMGS.Trade.Web.Football.Controls.FootballInplayMatchList";
        ...
        public IEnumerable<ScriptDescriptor> GetScriptDescriptors()
        {
            ...
            descriptor.AddElementProperty("inPlayTabs", inPlayTabs.ClientID);
            ...
            descriptor.AddProperty("inPlayTabId", InPlayTabId);
            descriptor.AddProperty("marketFlagList", MarketFlagList);
            descriptor.AddProperty("inplayTabList", InplayTabList);
        ...
        {
            yield return new ScriptReference(@"~/Football/Controls/FootballInplayMatchList.js");
        }
        #endregion
    }
}