...
YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3 = function (element) {
    YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3.initializeBase(this, [element]);
...
YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3.prototype = {
    _dataSource: null,
    _clientId: null,
    _language: 0,
    _buttonLst: null,
    ...
    initialize: function () {
        YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3.callBaseMethod(this, 'initialize');
        ...
        setInterval(function () {
            if (typeof (that) === 'undefined')
                return false;
            YMGS.Trade.Web.Services.MatchMarketService.GetTop3ChampMatchMarketDetalsList(that._language, that._champEventID, that._loadMatchMarketDetailsHandler, that._loadErrorHandler, null);
        }, 60000);
    },
    ...
    _constructMatchInfo: function (data) {
        ...
        //比赛名称--市场名称
        var matchName = data.MatchName + " - " + this._dataSource.MarketInfo[0].MKTmpName + " " + data.MatchEndDate;
        ...
        //if (data.IsDealAmountDisplayBelow == false) {
    ...
    _AddMatchMarketContainerBody: function () {
        ...
        var allData = this._dataSource.MarketInfo;
    ...
    _ClearUserControlData: function () {
        $('[id$=divChampMatchMarketTop3]').html("");
    },
    ...
    //公开的方法
    refresh: function () {
        YMGS.Trade.Web.Services.MatchMarketService.GetTop3ChampMatchMarketDetalsList(this._language, this._champEventID, this._loadMatchMarketDetailsHandler, this._loadErrorHandler, null);
    },

    dispose: function () {
        YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3.callBaseMethod(this, 'dispose');
        this.remove_betEvent(BetEventHandler);
    }
};


YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3.registerClass("YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3", Sys.UI.Control);

GenerateProps(YMGS.Trade.Web.Football.Controls.ChampMatchMarketTop3, [
    'dataSource',
    'clientId',
    'language',
    'buttonLst',
