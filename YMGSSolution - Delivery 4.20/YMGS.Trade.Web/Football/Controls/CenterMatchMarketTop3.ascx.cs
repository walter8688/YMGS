...
{
    public partial class CenterMatchMarketTop3 : System.Web.UI.UserControl, IScriptControl
    {
        ...
        internal const string ClientControlType = "YMGS.Trade.Web.Football.Controls.CenterMatchMarketTop3";
        ...
        public IEnumerable<ScriptDescriptor> GetScriptDescriptors()
        {
            ...
            descriptor.AddElementProperty("divMatchMarketTop3", divMatchMarketTop3.ClientID);
        ...
        {
            yield return new ScriptReference(@"~/Football/Controls/CenterMatchMarketTop3.js");
        }
        #endregion
    }
}