...
namespace YMGS.Manage.Web.Controls
{
    ...
    public partial class PageNavigator : System.Web.UI.UserControl
    {
        ...
        public int TotalCount
        {
            get
            {
                var s = this.totalCount.Text.Replace(LangManager.GetString("gong"), string.Empty).Replace(LangManager.GetString("tiaorecord"), string.Empty).Trim();
        ...
        public void PagerSetting(int pageSize, int totalCount)
        {
            try
            {
                ...
                this.totalCount.Text = string.Format(LangManager.GetString("totalrecord"), totalCount);
